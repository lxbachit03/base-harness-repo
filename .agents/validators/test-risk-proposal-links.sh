...
printf '%s\n' \
  ...
  'Resources:' \
  'Proposals are reached through nested links under TAG: [RISK].' \
  > "$EMPTY_FIXTURE/docs-harness/INDEX.md"
...
MANY_FIXTURE="$TMP_ROOT/many-to-many"
mkdir -p "$MANY_FIXTURE"
clone_valid "$MANY_FIXTURE"
python3 - "$MANY_FIXTURE" <<'PY'
import sys
from pathlib import Path

root = Path(sys.argv[1])
risks = root / "docs-harness" / "risks"
proposal = root / "docs-harness" / "proposals" / "0810-proposal-sample.md"
...
proposal_text = proposal_text.replace(
    ...
    "REFERENCES:\n"
    "- [#001_RISK_0810 Risk sample](../risks/0810-risk-sample.md)\n"
    "- [#003_RISK_0811 Risk second](../risks/0811-risk-second.md)",
)
proposal_text = proposal_text.replace(
    "## Related Risks\n\n- [#001_RISK_0810 Risk sample](../risks/0810-risk-sample.md)",
    "## Related Risks\n\n"
...
(risks / "0811-risk-second.md").write_text(
    """ID: #003_RISK_0811
TAG: [RISK]
PRIORITY: [CRITIAL]
TITLE: Risk second
...
src/second.cs:20, SecondSymbol, first-party execution path.

## Impact

Second sample impact.

## Indicators

Second sample indicator.
...
index = root / "docs-harness" / "INDEX.md"
index_text = index.read_text(encoding="utf-8")
index_text = index_text.replace(
    "  - Proposal: [#002_RISK_0810 Proposal sample](proposals/0810-proposal-sample.md)\n\n## Supporting Folders",
    "  - Proposal: [#002_RISK_0810 Proposal sample](proposals/0810-proposal-sample.md)\n\n"
    "- [#003_RISK_0811 Risk second](risks/0811-risk-second.md) — PRIORITY: [CRITIAL]\n"
    "  - Proposal: [#002_RISK_0810 Proposal sample](proposals/0810-proposal-sample.md)\n\n"
    "## Supporting Folders",
)
index.write_text(index_text, encoding="utf-8")
PY
run_case "many-to-many" 0 "$MANY_FIXTURE" 'PASS|SUMMARY|risks=2|proposals=1'
...
clone_valid "$CASE"
mutate_file \
  "$CASE/docs-harness/proposals/0810-proposal-sample.md" \
  '## Related Risks\n\n- [#001_RISK_0810 Risk sample](../risks/0810-risk-sample.md)' \
  '## Related Risks\n\nNo reciprocal link.'
run_case "one-way-link" 1 "$CASE" 'ERROR|RELATION|'
